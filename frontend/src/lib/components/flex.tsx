...
type FlexDirection = "row" | "row-reverse" | "column" | "column-reverse" | "bottom-to-top" | "top-to-bottom" | "right-to-left" | "left-to-right";
...
export function FlexContainer(props: FlexContainerProps) {
    ...
    return <div className={props.className} style={removeNulls(style)}>{props.children}</div>
}
